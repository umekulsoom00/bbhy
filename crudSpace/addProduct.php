...
?>  
    ...
    <div class="form-outline mb-4">
      ...
      <select name="category" id= "category" onChange = "categoryChange(this.value)" required   class="form-select">
...
if (isset($_POST['btnSave'])) {
    ...
    if(move_uploaded_file($tmpname,$saveimg))
    {
        ...
        $queryInsert= 'INSERT INTO product(productName,productPrice,productQuantity,productImage,categoryId,subcategoryId) VALUES("'.$productName.'" , "'.$productPrice.'", "'.$productQuantity.'","'.$saveimg.'","'.$category.'","'.$subcategory.'")';
