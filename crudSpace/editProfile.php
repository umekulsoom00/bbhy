...
<form method="POST" enctype=multipart/form-data>
              ...
              <input type="email"  value=" <?php echo $r["userEmail"]?> " name="Email"  class="form-control form-control-lg" />
                  ...
                  <div class="form-outline mb-4">
                  <input type="password" value="<?php echo $r["userPassword"]?> " name="Pass"  class="form-control form-control-lg" />
                  ...
                  <div class="pt-1 mb-4">
                    <button class="btn btn-dark btn-lg "  name="submit" >Save</button>
                  </div>
                  </form>
...
if ($userEmail == "" || $userPassword == "" ) {
  ...
  $id = $_GET["id"];
$query ="UPDATE `user` SET `userEmail`='$userEmail',`userPassword`='$userPassword' WHERE userId = '$id'";
